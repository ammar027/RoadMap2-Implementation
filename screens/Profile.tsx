...
//   // Call the native login screen
//   const handleShowLoginScreen = () => {
//     LoginModule.showLoginScreen();
//   };

//   // Call the native signup screen
...
//       ) : (
//         <View style={styles.actionContainer}>
//           <TouchableOpacity style={styles.button} onPress={handleShowLoginScreen}>
//             <Icon name="login" size={20} color="#fff" />
...
//   saveButton: { backgroundColor: 'green', marginBottom: 12 },
//   logoutButton: { backgroundColor: 'tomato' },
//   signupButton: { backgroundColor: 'purple', marginTop: 16 },
//   buttonText: { marginLeft: 12, color: '#fff', fontSize: 16, fontWeight: '600' },
// });
